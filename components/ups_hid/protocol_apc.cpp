...
static const uint8_t APC_REPORT_ID_OUTPUT_VOLTAGE = 0x29;  // PowerSummary.Voltage (legacy)
...
static const uint8_t APC_REPORT_ID_INPUT_VOLTAGE_NOMINAL = 0x31; // Input voltage nominal  
